...
The frontend SHALL provide a mobile-first application structure suitable for daily household use.

#### Scenario: Mobile navigation
- **Given** a user opens the app on a phone-sized screen
- **When** the main authenticated pages render
- **Then** the layout remains usable for key sections such as home, menu, orders, favorites, profile, and wishes
